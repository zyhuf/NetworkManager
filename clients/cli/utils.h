...
typedef enum {
	...
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_CHASSIS_ID = 0,
	...
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_MANAGEMENT_ADDRESSES,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_PVID,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_PPVID,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_PPVID_FLAGS,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_PPVIDS,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_VID,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_VLAN_NAME,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_DESTINATION,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_CHASSIS_ID_TYPE,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_PORT_ID_TYPE,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_DEVICE,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_VLANS,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_MAC_PHY_CONF,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_POWER_VIA_MDI,
	NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_MAX_FRAME_SIZE,
	_NMC_GENERIC_INFO_TYPE_DEVICE_LLDP_NUM,
} NmcGenericInfoType;
