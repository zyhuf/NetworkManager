...
{
	if (nm_streq0 (vpn_type, "openvpn"))     return "remote";
	if (nm_streq0 (vpn_type, "vpnc"))        return "IPSec gateway";
	if (nm_streq0 (vpn_type, "pptp"))        return "gateway";
	if (nm_streq0 (vpn_type, "openconnect")) return "gateway";
	if (nm_streq0 (vpn_type, "openswan"))    return "right";
	if (nm_streq0 (vpn_type, "libreswan"))   return "right";
	if (nm_streq0 (vpn_type, "ssh"))         return "remote";
	if (nm_streq0 (vpn_type, "l2tp"))        return "gateway";
	return NULL;
}
...
{
	if (nm_streq0 (vpn_type, "openvpn"))     return "username";
	if (nm_streq0 (vpn_type, "vpnc"))        return "Xauth username";
	if (nm_streq0 (vpn_type, "pptp"))        return "user";
	if (nm_streq0 (vpn_type, "openconnect")) return "username";
	if (nm_streq0 (vpn_type, "openswan"))    return "leftxauthusername";
	if (nm_streq0 (vpn_type, "libreswan"))   return "leftxauthusername";
	if (nm_streq0 (vpn_type, "l2tp"))        return "user";
	return NULL;
}
