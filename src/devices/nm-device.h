 ...
 * @NM_UNMANAGED_CHILD: %TRUE when unmanaged because the device is a child/subdevice
 */
typedef enum {
...
gboolean nm_device_get_only_default_unmanaged (NMDevice *device);
