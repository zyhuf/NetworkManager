 ...
 * via update_connection() virtual functions is available for this device.
 *
 ...
 *
 * Returns: %TRUE for assumable connections and %FALSE for full-cleanup connections.
 *
...
nm_device_can_assume_connections (NMDevice *device)
{
	...
	return !!klass->update_connection;
}
