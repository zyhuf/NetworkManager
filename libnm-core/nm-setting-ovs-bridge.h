...
NM_AVAILABLE_IN_1_10
const char *nm_setting_ovs_bridge_get_fail_mode             (NMSettingOvsBridge *s_ovs_bridge);
NM_AVAILABLE_IN_1_10
gboolean    nm_setting_ovs_bridge_get_mcast_snooping_enable (NMSettingOvsBridge *s_ovs_bridge);
NM_AVAILABLE_IN_1_10
gboolean    nm_setting_ovs_bridge_get_rstp_enable           (NMSettingOvsBridge *s_ovs_bridge);
NM_AVAILABLE_IN_1_10
gboolean    nm_setting_ovs_bridge_get_stp_enable            (NMSettingOvsBridge *s_ovs_bridge);
