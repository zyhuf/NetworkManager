...
void        nm_tc_qdisc_set_parent           (NMTCQdisc *qdisc,
                                              guint32 parent);
NM_AVAILABLE_IN_1_12
guint32     nm_tc_qdisc_get_info             (NMTCQdisc *qdisc);
NM_AVAILABLE_IN_1_12
...
NM_AVAILABLE_IN_1_12
void        nm_tc_action_set_kind            (NMTCAction *action,
                                              const char *kind);
...
NM_AVAILABLE_IN_1_12
void        nm_tc_tfilter_set_kind           (NMTCTfilter *tfilter,
                                              const char *kind);
NM_AVAILABLE_IN_1_12
int         nm_tc_tfilter_get_family         (NMTCTfilter *tfilter);
NM_AVAILABLE_IN_1_12
void        nm_tc_tfilter_set_family         (NMTCTfilter *tfilter,
                                              int family);
NM_AVAILABLE_IN_1_12
...
NM_AVAILABLE_IN_1_12
void        nm_tc_tfilter_set_parent         (NMTCTfilter *tfilter,
                                              guint32 parent);
NM_AVAILABLE_IN_1_12
guint32     nm_tc_tfilter_get_info           (NMTCTfilter *tfilter);
NM_AVAILABLE_IN_1_12
void        nm_tc_tfilter_set_info           (NMTCTfilter *tfilter,
                                              guint32 info);
NM_AVAILABLE_IN_1_12
