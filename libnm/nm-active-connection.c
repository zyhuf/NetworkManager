...
is_ready (NMObject *nmobj)
{
	 ...
	 * objects that are not yet initialized, that reference will just be NULL.
	 *
	 * For NMActiveConnection's reference to the NMConnection don't do that. Here we require
	 * the setting to be initalized. */
